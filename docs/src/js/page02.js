...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // visibility
    invis.onpointerdown  = () => {canvas.style.opacity = "0"};
    [screen, gamepad, joypad].forEach(el => el.onpointerdown = () => canvas.style.opacity = "1");
    document.onvisibilitychange = () => !document.hidden && (canvas.style.opacity = "1");
});